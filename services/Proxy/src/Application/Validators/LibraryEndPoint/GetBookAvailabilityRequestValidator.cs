...
{
    public class GetBookAvailabilityRequestValidator : AbstractValidator<GetBookAvailabilityQuery>
    {
        public GetBookAvailabilityRequestValidator()
        {
            RuleFor(x => x.BookId)
                .NotEmpty()
